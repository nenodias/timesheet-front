<template>
     ...
     <div class="box box-default">
       <div class="box-header with-border">
         <h3 class="box-title" style="color: gray;">
           <i class="fa fa-edit"></i> &nbsp;Seleção do período
         </h3>
       </div>
       <div>
         <p></p>
         <b>&nbsp;&nbsp;(*)</b>&nbsp;Preenchimento obrigatório
         <p></p>
       </div>
       <form class="form-horizontal">
         <div class="box-body">
           ...
           <div class="form-group">
             <label class="col-sm-2 control-label" for="period">
               Período
               <b class="required-field">*</b>
             </label>
             <div class="col-sm-2">
               <select class="form-control" name="period" id="period" v-model="period">
 ...
 export default {
   ...
   methods: {
     search() {
       const urlPath = `/timesheet/${this.employeeId}/${this.year}/${this.month}/${this.period}`;
